...
<p>
Why do some protest movements escalate from peaceful demonstrations to violent confrontation while others never change tactics? I develop a dynamic model in which an organizer chooses between a turnout-sensitive tactic (peaceful mass mobilization) and a tactic with higher baseline power but less turnout scalability (violent or confrontational action). Turnout is endogenous: citizens decide whether to participate based on public beliefs about regime strength, and failed protests shift those beliefs pessimistically. The organizer balances immediate effectiveness against the informational consequences of failure. Three equilibrium regimes emerge. When violence lacks meaningful baseline capacity, peace is optimal throughout. At intermediate values, peace is used first but movements escalate after weak, uninformative failures. When violence is both powerful at baseline and highly scalable, the organizer leads with it, and the continuation is path-dependent. I map these regimes to features of the political and physical environment, generating predictions about tactical persistence and escalation and a structural account of the observed correlation between nonviolent tactics and campaign success. On the technical side, the model also offers a resolution to equilibrium multiplicity in dynamic global games by having agents receive private cost rather than information signals.
  </p>
</details>
...
[(Publisher's version)](https://onlinelibrary.wiley.com/doi/10.1111/ajps.12986) [(Slides)](https://ecyao.github.io/files/pdf/bnc_slides.pdf) [(Nontechnical summary)](https://ajps.org/2025/05/12/brook-no-compromise-how-to-negotiate-a-united-front/) 
